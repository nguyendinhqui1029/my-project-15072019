    ...
    <div class="row">
        <div class="col-9">
                <div class="content-box" >
                        <div class="intro"> 
                            Thông tin góp ý - phản hồi của bạn sẽ giúp chúng tôi phục vụ bạn ngày càng tốt hơn</div>
        ...
        <div class="col-3">
                <div class="content-right">
                        <div style=" font-weight: bold;font-size: 16px;text-align: center;"> Hỗ trợ trực tuyến</div>
                        <div class="itemm">
                                <div class="namee">Ms.Trang</div>
                                <div class="phonee">0945 243 197</div>
                        </div>
                        <div class="itemm">
                                <div class="namee">Ms.Nguyên</div>
                                <div class="phonee">0945 243 197</div>
                        </div>
                        <div class="itemm">
                                <div class="namee">Ms.Giang</div>
                                <div class="phonee">0976 804 401</div>
                        </div>
                        <div class="itemm itemm1">
                                <div class="namee">Kế toán</div>
                                <div class="phonee">0937 63 60 62</div>
                        </div>
                    </div>
        </div>
    </div>
