...
<div><a href="nha-dat-ban-chi-tiet/{{$item->ID_DangTin}}">{{$item->TieuDe}}</a> <img src="assets/images/new.gif" /></div>
    <div class="row" style="margin-top: 10px">
        <div class="col-6" style="margin-left: 5px"><b>Địa chỉ: </b>{{$item->DiaChi}}</div>
