<div class="admin">
        <form action="{{url('admin-kinh-nghiem?chucnang='.$chucnang)}}" method="POST">
                {!! csrf_field() !!}
            <fieldset>
                <legend style="margin-bottom: 30px; ">Kinh Nghiệm</legend>
                @if (!empty($data))
            ...
            Hình ảnh: <input value="{{$data->HinhAnh}}" style="width: 300px;margin-left: 60px"  type="file" required name="txthinhanh"><br>
                ...
                <input value="{{$data->ID_KinhNghiem}}" name="id" style="width: 300px;margin-left: 80px"  type="hidden" >
                @else
